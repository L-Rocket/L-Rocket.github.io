...
publishDate: '2026-03-01T15:30:00+08:00'
draft: false
title: 'DuckDNS Updater'
description: 'A lightweight, efficient DuckDNS client written in Go for automatic domain updates.'
tags: ['project', 'go', 'dns', 'automation']
---

## Overview

DuckDNS Updater is a lightweight, efficient DuckDNS client written in Go. It provides a reliable way to keep your DuckDNS domains updated with your current public IP address, ensuring your services remain accessible even when your IP changes.
...
- Code: https://github.com/L-Rocket/duck-ddns
- Documentation: https://github.com/L-Rocket/duck-ddns/blob/main/README.md
